import { CheckboxOptionType, MenuProps } from 'antd';
...
export const getOptions = (arr: Array<basketMain | mainProductsType>) => {
    return arr.map(item => {
        return {
            label: item.name,
            value: item.name
...
export const getNewArray = (arr:Array<mainProductsType>,value:Array<string>)=> {
